        ...
        {patientList && patientList.map((patient,index) => (
          <li key={index} className="flex justify-between gap-x-6 py-5">
            ...
            <div className="flex flex-col min-w-0 gap-x-4">
              ...
              </div><p className="text-sm leading-6 text-gray-900 mt-1">{patient.email}</p>
            </div>
            </div>
            <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end  w-1/3">
              <p className="text-sm leading-6 text-gray-900">{patient.severity}</p>
             
              <p className="text-sm leading-6 text-gray-900 mt-1">{patient.address}</p>
