...
<aside  className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-teal-800 border-r border-gray-200 sm:translate-x-0 dark:bg-teal-800 dark:border-teal-100" aria-label="Sidebar">
      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <button onClick={()=>{
              ...
              {/* <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="gray" viewBox="0 0 20 20"> */}
              <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Pending Requests</span>
            </button>
         </li>
         <li>
            <button onClick={()=> {
