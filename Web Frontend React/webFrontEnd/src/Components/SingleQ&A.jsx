...
export const SingleQAndA = ({id}) => {
    ...
    console.log(questionDetails.comments);
    ...
    <div className="w-11/12 h-screen bg-teal-50">
        <div className=" w-full h-full bg-teal-50 ">
            <div className="flex  justify-center text-white  bg-teal-800 w-full h-16 mt-3 rounded-t-3xl text-3xl font-black p-3 mt-12">Question</div>
            <div className="flex flex-col justify-center bg-teal-400 w-full rounded-b-3xl px-10  h-2/5">
               {/* <div className="mb-2 text-2xl font-bold text-teal-700 mt-5">{questionDetails.description}</div>  */}
               <div className="mb-10 text-slate-600 mt-3">{questionDetails.content}</div>
            ...
            <div className="bg-teal-400 rounded-b-3xl mt-6 "> 
              <div className="bg-teal-700 text-md font-bold px-6 py-2 text-gray-50">Replies by others</div> 
...
function CommentTextArea({id}){
   ...
   <div className="w-full mb-4 border border-gray-200 rounded-t-3xl bg-teal-200 dark:bg-teal-700 dark:border-teal-100">
       <div className="px-5 py-4 bg-teal-100 rounded-t-3xl dark:bg-teal-400">
           ...
           }} rows="4" className="w-full px-4 text-sm text-teal-900 focus:ring-teal-400 bg-teal-50 border-0 dark:bg-teal-100 focus:ring-2 dark:text-teal-800 dark:placeholder-teal-800" placeholder="Reply..." required ></textarea>
       </div>
