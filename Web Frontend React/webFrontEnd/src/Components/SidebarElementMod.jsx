...
import { DoctorListMod } from "./DoctorListMod";
import { AllPostMod } from "./AllPostMod";
...
export const SidebarElement = () => {
   const[option , setOption] = useState(2);
    return<div className="flex flex-col">
      ...
      Moderator
          <div className="flex items-center">
              <div className="flex items-center ms-3">
               ...
               <div className=" hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" ></div>
             </div>
         </div>
      </div>
  </div>
      ...
      <div>
      <aside  className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-teal-800 dark:border-teal-100" aria-label="Sidebar">
   <div className="h-full px-3 pb-4 overflow-y-auto bg-teal-800 dark:bg-teal-800">
      <ul className="space-y-2 font-medium">
         <li>
            <button onClick={()=>{
               ...
               <span className="ms-3">All Patients</span>
            </button>
         </li>
         <li>
            <button onClick={()=>{
         ...
         <li>
            ...
            setOption(3);
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">All Doctors</span>
         ...
         {/* <li>
            <button onClick={()=>{
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Chats Trial</span>
            </button>
         </li> */}
    ...
    <div className="p-4 sm:ml-64">
         ...
         <div className="w-full"><Desktop option={option}/></div>
