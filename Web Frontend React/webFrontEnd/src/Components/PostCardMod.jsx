...
<div class="max-w-4xl pl-5 pr-10 my-4 py-6 bg-teal-400 rounded-lg shadow-md ">
        <div class="flex justify-between items-center">
            ...
            <button onClick={async ()=>{
                try{
                    const response = await axios.delete(`${BACKEND_URL}/api/posts/post/${id}`,{
                        headers:{
            ...
            }}class="px-2 py-1 bg-teal-800 text-gray-100 font-bold rounded-xl hover:bg-teal-700" >Delete Post</button>
        </div>
        <div class="mt-2 pl-6">
...
<div class="max-w-4xl pl-5 pr-10 my-4 py-6 bg-teal-400 rounded-lg shadow-xl shadow-red-900">
        <div class="flex justify-between items-center">
            {/* <span class="font-light text-gray-600">{createdAt}</span> */}
            <div className="">
                <a class="flex items-center " href="#">
